...
class AreaCalculator:
    ...
    def area_sum(self):
        ...
        for shape in self.shapes:
            if isinstance(shape, Shape): #Liskov Substitution #Remember Sphere is a 3dShape which is a shape
                areas.append(self.calc(shape))                
            else:
...
def main(shapes):
    ...
    print(issubclass(Sphere, Shape))
    print(issubclass(Square, ShapeThreeD))
